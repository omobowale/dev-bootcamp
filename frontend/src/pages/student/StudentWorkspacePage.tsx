...
export function StudentWorkspacePage(){const {pathname}=useLocation();return <div className="student-shell"><header className="student-topbar"><div className="container student-topbar__inner"><Link className="student-topbar__brand" to="/student">DevTraining<span>Learning space</span></Link><ThemeToggle/></div></header><StudentTools/><main className="container student-page">{pathname.endsWith("notifications")?<Notifications/>:<Planner/>}</main></div>;}
