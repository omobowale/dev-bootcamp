...
export function AboutPage() {
  ...
  return <>
    <section className="page-intro about-intro"><div className="container"><span className="eyebrow"><Icon name="spark" size={15} /> THE DEVTRAINING WAY</span><h1>Great developers aren't born.<br /><em>They're built.</em></h1><p>We believe the best way to learn software development is to build software. With curiosity, practice, and people in your corner.</p><Link to="/courses" className="btn btn-primary">Find your starting point <Icon name="arrow" size={16} /></Link></div></section>
