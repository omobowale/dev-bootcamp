...
export function Footer() {
  ...
  return <footer className="site-footer"><div className="container"><div className="footer-main">
    ...
    <nav aria-label="Company links"><h3>BUKIVA LEARN</h3><Link to="/about">About us</Link><Link to="/about#team">Meet the team</Link><Link to="/terms">Terms & conditions</Link><Link to="/about#faq">Help & FAQs</Link><Link to="/about#contact">Get in touch</Link></nav>
